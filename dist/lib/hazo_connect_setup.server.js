...
function get_hazo_connect_config() {
    ...
    const type = ((hazo_connect_section === null || hazo_connect_section === void 0 ? void 0 : hazo_connect_section.type) ||
        process.env.HAZO_CONNECT_TYPE ||
        "sqlite").toLowerCase();
    // Read enable_admin_ui (defaults to true)
    const enable_admin_ui_str = (hazo_connect_section === null || hazo_connect_section === void 0 ? void 0 : hazo_connect_section.enable_admin_ui) ||
    ...
    const read_only_str = (hazo_connect_section === null || hazo_connect_section === void 0 ? void 0 : hazo_connect_section.read_only) ||
        process.env.HAZO_CONNECT_SQLITE_READONLY ||
        "false";
    const readOnly = read_only_str.toLowerCase() === "true";
    // SQLite configuration
    if (type === "sqlite") {
        const sqlite_path_config = (hazo_connect_section === null || hazo_connect_section === void 0 ? void 0 : hazo_connect_section.sqlite_path) || process.env.HAZO_CONNECT_SQLITE_PATH;
        let sqlite_path;
        if (sqlite_path_config) {
            ...
            const fallback_sqlite_path = path.resolve(process.cwd(), "__tests__", "fixtures", "hazo_auth.sqlite");
    ...
    if (type === "postgrest") {
        const postgrest_url = (hazo_connect_section === null || hazo_connect_section === void 0 ? void 0 : hazo_connect_section.postgrest_url) ||
        ...
        const postgrest_api_key = process.env.postgrest_api_key || // hazo_connect package expects this
