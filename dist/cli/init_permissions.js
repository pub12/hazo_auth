 ...
 */
export async function handle_init_permissions() {
    var _a, _b;
    ...
    try {
        ...
        for (const permission_name of permission_names) {
            ...
            if (Array.isArray(existing_permissions) && existing_permissions.length > 0) {
                ...
                const inserted_id = Array.isArray(result) ? (_b = (_a = result[0]) === null || _a === void 0 ? void 0 : _a.id) !== null && _b !== void 0 ? _b : "(auto)" : "(auto)";
 ...
 */
export function show_init_permissions_help() {
    console.log(`
hazo_auth init-permissions
