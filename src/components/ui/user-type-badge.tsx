...
const PRESET_COLOR_CLASSES: Record<BadgeColorPreset, string> = {
 ...
 */
export function UserTypeBadge({ label, color, className }: UserTypeBadgeProps) {
    ...
    return (
      <span
        className={cn(
          ...
          PRESET_COLOR_CLASSES[color as BadgeColorPreset],
          className
        )}
      >
        {label}
