...
export function TwoColumnAuthLayout({
  ...
  return (
    <div
      className={`cls_two_column_auth_layout grid w-full max-w-5xl grid-cols-1 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm md:grid-cols-2 md:min-h-[520px] ${className ?? ""}`}
    >
      <VisualPanel
        imageSrc={imageSrc}
        imageAlt={imageAlt}
