 ...
 */
function parse_schema(schema_string: string): AppUserDataSchema | null {
  ...
  try {
    ...
    return parsed as AppUserDataSchema;
  } catch (error) {
 ...
 */
function extract_section_labels(
 ...
 */
export function get_app_user_data_config(): AppUserDataConfig {
 ...
 */
export function get_app_user_data_schema(): AppUserDataSchema | null {
 ...
 */
export function is_app_user_data_schema_enabled(): boolean {
  const config = get_app_user_data_config();
  return config.enable_schema && config.schema !== null;
}
 ...
 */
export function get_section_label(key: string): string {
  const config = get_app_user_data_config();
 ...
 */
export function get_field_label(key: string, parent_key?: string): string {
  let label_key = key;
