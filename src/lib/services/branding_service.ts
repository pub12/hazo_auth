 ...
 */
export function validate_branding(data: UpdateBrandingData): {
  valid: boolean;
  error?: string;
} {
 ...
 */
export async function get_scope_branding(
 ...
 */
export async function get_effective_branding(
  adapter: HazoConnectAdapter,
  scope_id: string,
): Promise<BrandingServiceResult> {
  try {
 ...
 */
export async function replace_branding(
  adapter: HazoConnectAdapter,
  scope_id: string,
  branding: FirmBranding | null,
): Promise<BrandingServiceResult> {
 ...
 */
export async function clear_branding(
  adapter: HazoConnectAdapter,
  scope_id: string,
): Promise<BrandingServiceResult> {
 ...
 */
export async function get_user_firm_branding(
  adapter: HazoConnectAdapter,
