// file_description: API route handler for listing library photo categories and photos
// section: imports
import { NextRequest, NextResponse } from "next/server";
import {
  get_library_categories,
  get_library_photos_paginated,
  get_library_source
} from "../../lib/services/profile_picture_service";
