...
import { SQLITE_SCHEMA } from "../lib/schema/sqlite_schema";
 ...
 */
function read_sqlite_path_from_config(config_path: string): string | undefined {
 ...
 */
function has_hazo_users_table(db_path: string): boolean {
  try {
...
export function handle_init_db(): void {
