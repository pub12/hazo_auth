...
function get_create_firm_config() {
  return {
    image_src: get_config_value(
      "hazo_auth__create_firm",
      "image_src",
      "/hazo_auth/images/new_firm_default.jpg"
    ),
    ...
    sub_heading: get_config_value(
      "hazo_auth__create_firm",
      "sub_heading",
      "Set up your organisation to get started"
    ),
    firm_name_label: get_config_value(
      "hazo_auth__create_firm",
      "firm_name_label",
      "Firm Name"
    ),
    org_structure_label: get_config_value(
      "hazo_auth__create_firm",
      "org_structure_label",
      "Organisation Structure"
    ),
    org_structure_default: get_config_value(
      "hazo_auth__create_firm",
      "org_structure_default",
      "Headquarters"
    ),
    submit_button_label: get_config_value(
      "hazo_auth__create_firm",
      "submit_button_label",
      "Create Firm"
    ),
    success_message: get_config_value(
      "hazo_auth__create_firm",
      "success_message",
      "Your firm has been created successfully!"
    ),
    redirect_route: get_config_value(
      "hazo_auth__create_firm",
      "redirect_route",
      "/"
    ),
...
// section: component
export default function CreateFirmPage({ disableNavbar }: CreateFirmPageProps = {}) {
  ...
  const layoutContent = (
    <CreateFirmLayout
      ...
      firm_name_label={config.firm_name_label}
      org_structure_label={config.org_structure_label}
      default_org_structure={config.org_structure_default}
      submit_button_label={config.submit_button_label}
  ...
  return <AuthPageShell>{layoutContent}</AuthPageShell>;
}
